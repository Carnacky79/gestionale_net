namespace WarehouseManagementSystem
{
    partial class frmPlaceOrders
    {
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmPlaceOrders));
			...
			this.Label11.Text = "Qtà. Da Acquistare";
			// 
			// Button7
			// 
			...
			// columnHeader6
			// 
			this.columnHeader6.Text = "ID Prodotto";
			this.columnHeader6.Width = 80;
			// 
			// ColumnHeader2
			// 
			this.ColumnHeader2.Text = "Nome Prodotto";
			this.ColumnHeader2.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.ColumnHeader2.Width = 270;
			// 
			// ColumnHeader3
			// 
			this.ColumnHeader3.Text = "Prezzo Unità";
			this.ColumnHeader3.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.ColumnHeader3.Width = 90;
			// 
			// ColumnHeader4
			// 
			this.ColumnHeader4.Text = "Qtà.";
			this.ColumnHeader4.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.ColumnHeader4.Width = 85;
			// 
			// ColumnHeader5
			// 
			this.ColumnHeader5.Text = "Totale";
			...
			this.label18.Text = "Tipo Pagamento";
			// 
			// txtDiscountAmount
			// 
			...
			this.Label19.Text = "Pagamento Rim.";
			// 
			// payment
			// 
			...
			this.payment.Size = new System.Drawing.Size(108, 17);
			this.payment.TabIndex = 95;
			this.payment.Text = "Totale Pagamento";
			// 
			// txtTotal
			// 
			...
			this.btnPrint.Text = "&Stampa Ricevuta";
			...
			this.groupBox2.Text = "Cerca by Nome Prodotto";
			// 
			// txtProduct
			// 
