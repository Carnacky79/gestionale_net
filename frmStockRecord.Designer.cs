namespace WarehouseManagementSystem
{
    partial class frmStockRecord
    {
        ...
        private void InitializeComponent()
        {
			...
			this.groupBox2.Text = "Cerca By Stock Data";
			// 
			// button3
			// 
			...
			// Column7
			// 
			this.Column7.HeaderText = "Stock Data";
			this.Column7.Name = "Column7";
			this.Column7.ReadOnly = true;
			// 
			// Column8
			// 
			this.Column8.HeaderText = "Prodotto ID";
			this.Column8.Name = "Column8";
			this.Column8.ReadOnly = true;
			// 
			// Column2
			// 
			this.Column2.HeaderText = "Prodotto Nome";
			...
			// Column4
			// 
			this.Column4.HeaderText = "Fornitore ID";
			this.Column4.Name = "Column4";
			this.Column4.ReadOnly = true;
			// 
			// Column5
			// 
			this.Column5.HeaderText = "Nome Fornitore";
			...
			// Column6
			// 
			this.Column6.HeaderText = "Qtà";
			this.Column6.Name = "Column6";
			this.Column6.ReadOnly = true;
			// 
			// Column9
			// 
			this.Column9.HeaderText = "Data Scadenza";
