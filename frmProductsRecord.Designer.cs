namespace WarehouseManagementSystem
{
    partial class frmProductsRecord
    {
        ...
        private void InitializeComponent()
        {
			...
			this.groupBox1.Text = "Cerca by Nome Prodotto";
			// 
			// txtProductname
			// 
			...
			this.groupBox2.Text = "Cerca by Categoria";
			// 
			// txtCategory
			// 
			...
			this.groupBox3.Text = "Cerca by SubCategoria";
			// 
			// txtSubCategory
			// 
			...
			// Column8
			// 
			this.Column8.HeaderText = "Nome Prodotto";
			...
			// Column3
			// 
			this.Column3.HeaderText = "Nome Categoria";
			...
			// Column4
			// 
			this.Column4.HeaderText = "ID Sub Categoria";
			this.Column4.Name = "Column4";
			this.Column4.ReadOnly = true;
			// 
			// Column5
			// 
			this.Column5.HeaderText = "Sub Categoria Nome";
			...
			// Column7
			// 
			this.Column7.HeaderText = "Prezzo";
			this.Column7.Name = "Column7";
			this.Column7.ReadOnly = true;
			// 
			// Column9
			// 
			this.Column9.HeaderText = "Img";
			...
			// Column10
			// 
			this.Column10.HeaderText = "Data Scadenza";
