namespace WarehouseManagementSystem
{
    partial class frmCustomerOrders
    {
        ...
        private void InitializeComponent()
        {
			...
			this.Label5.Text = "Pagamento Dov.";
			// 
			// Label1
			// 
			...
			this.Label1.Text = "Total Pagamento";
			// 
			// Label2
			// 
			...
			this.TabPage3.Text = "Tutti gli Ordini";
			...
			this.Label6.Text = "Pagamento Dov.";
			// 
			// Label7
			// 
			...
			this.Label7.Text = "Total Pagamento";
			// 
			// Label8
			// 
