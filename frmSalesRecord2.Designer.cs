namespace WarehouseManagementSystem
{
    partial class frmSalesRecord2
    {
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmSalesRecord2));
			...
			this.TabPage1.Text = "Ordina By Data";
			...
			this.Label5.Text = "Pagamento Rim";
			// 
			// Label1
			// 
			...
			this.Label1.Text = "Pagamento Tot";
			// 
			// Label2
			// 
			...
			this.button10.Text = "&Vedi Report";
			...
			this.Label16.Text = "Nome Cliente";
			// 
			// TabPage2
			// 
			...
			this.TabPage2.Text = "By Pagamento Rim";
			...
			this.Label14.Text = "Pagamento Rim";
			// 
			// Label15
			// 
			...
			this.Label15.Text = "Pagamento Tot";
			// 
			// Label17
			// 
			...
			this.button11.Text = "&Vedi Report";
			...
			this.ClientSize = new System.Drawing.Size(1311, 439);
