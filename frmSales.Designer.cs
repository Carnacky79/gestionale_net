namespace WarehouseManagementSystem
{
    partial class frmSales
    {
        ...
        private void InitializeComponent()
        {
			...
			this.Label19.Text = "Pagamento Dov";
			// 
			// payment
			// 
			...
			this.payment.Size = new System.Drawing.Size(67, 17);
			this.payment.TabIndex = 95;
			this.payment.Text = "Totale Pag";
			// 
			// txtTotal
			// 
