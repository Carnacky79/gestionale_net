namespace WarehouseManagementSystem
{
    partial class frmSalesRecord1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.TabPage3.Text = "Ordina By Cliente";
			...
			this.Label6.Text = "Pagamento Rim";
			// 
			// Label7
			// 
			...
			this.Label7.Text = "Pagamento Tot";
			// 
			// Label8
			// 
			...
			this.TabPage2.Text = "Ordina by Pag.Rim.";
