namespace WarehouseManagementSystem
{
    partial class frmOrder
    {
        ...
        private void InitializeComponent()
        {
			...
			this.Button7.Text = "&Agg. Carrello";
			...
			this.payment.Text = "Pagamento Tot";
			// 
			// txtTotal
			// 
			...
			this.btnPrint.Text = "&Stampa Fatt";
